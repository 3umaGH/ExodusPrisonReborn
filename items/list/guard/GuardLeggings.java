...
public class GuardLeggings extends Item {

	public GuardLeggings(int level) {
		super("Guards Leggings [LV. " + level + "]", Material.CHAINMAIL_LEGGINGS);
		...
		if(level >= 4)
			this.setMaterial(Material.DIAMOND_LEGGINGS);
