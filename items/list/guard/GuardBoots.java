...
public class GuardBoots extends Item {

	public GuardBoots(int level) {
		super("Guards Boots [LV. " + level + "]", Material.CHAINMAIL_BOOTS);
		...
		if(level >= 4)
			this.setMaterial(Material.DIAMOND_BOOTS);
