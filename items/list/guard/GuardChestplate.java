...
public class GuardChestplate extends Item {

	public GuardChestplate(int level) {
		super("Guards Chestplate [LV. " + level + "]", Material.CHAINMAIL_CHESTPLATE);
		...
		if(level >= 4)
			this.setMaterial(Material.DIAMOND_CHESTPLATE);
